...
const sanitizeCSSValue = (value: string): string | null => {
  // Allow only safe CSS color formats: hex, rgb(a), hsl(a), named colors, oklch, etc.
  const safeColorPattern = /^(#[0-9a-fA-F]{3,8}|rgba?\([^)]+\)|hsla?\([^)]+\)|oklch\([^)]+\)|[a-zA-Z]{1,30}|var\(--[a-zA-Z0-9-]+\))$/;
